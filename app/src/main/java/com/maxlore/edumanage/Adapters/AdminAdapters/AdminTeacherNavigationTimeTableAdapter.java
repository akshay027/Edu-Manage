 ...
 */
public class AdminTeacherNavigationTimeTableAdapter extends BaseAdapter {
    private final LayoutInflater inflater;
    private Activity activity;
    private List<TeacherTimeTableDetails> arrayList;


    public AdminTeacherNavigationTimeTableAdapter(Activity activity, List<TeacherTimeTableDetails> arrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TeacherTimeTableDetails timeTable = arrayList.get(position);
        if (convertView == null) {
