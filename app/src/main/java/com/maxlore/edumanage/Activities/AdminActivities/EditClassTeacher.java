...
public class EditClassTeacher extends AppCompatActivity {
    ...
    private String old_employee_id, Standard, Section, sectionid, currentcls, old_class_teacher_id;
    private int spinpos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            old_employee_id = getIntent().getStringExtra("old_employee_id");
            ...
            old_class_teacher_id = getIntent().getStringExtra("old_class_teacher_id");
    ...
    private void filterSearch(String search) {
       try{ listTeacherArrayList.clear();
    ...
    private void editTeacher() {
        try {
            if (UIUtil.isInternetAvailable(this)) {
                ...
                jsonObject.addProperty("old_class_teacher", old_employee_id);
                jsonObject.addProperty("id", old_class_teacher_id);
                ...
                RetrofitAPI.getInstance(this).getApi().editdeleteTeacher(jsonObject, new Callback<JsonObject>() {
                    ...
                    public void success(JsonObject object, Response response) {
                        ...
                        try {
                            if (object == null) {
                                Toast.makeText(EditClassTeacher.this, "Something went wrong, try after sometime...", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            if (object.get("status").getAsInt() == Constants.SUCCESS) {
                                Toast.makeText(EditClassTeacher.this, object.get("message").getAsString(), Toast.LENGTH_SHORT).show();
                            }
