...
/**
 * Created by maxlore on 4/11/2017.
 */

public class ParentSchoolInfoActivity extends AppCompatActivity {
    ...
    private String image, schoolname;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        poster.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ParentSchoolInfoActivity.this, SchoolInfoImageviewActivity.class);
